...
**`englishTitle`** (string, optional)  
English version of the title. May be identical to `title`
...
When the article was created in our system (ISO 8601 UTC)
